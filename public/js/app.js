...
class SAIIApp {
    ...
    async init() {
        ...
        // Setup MutationObserver to automatically convert dynamically rendered table emojis to clean linear SVGs
        ...
        iconObserver.observe(document.querySelector('.main-content') || document.body, {
            childList: true,
            subtree: true
        });
    ...
    setupLoginForm() {
        ...
        if (togglePassword && passwordInput && eyeIcon) {
            togglePassword.addEventListener('click', () => {
                ...
                // Cambiar el icono SVG entre ojo abierto y ojo tachado (Feather icons style)
                if (type === 'text') {
                    eyeIcon.innerHTML = `
    ...
    async logout() {
        try {
            const currentUser = DataManager.currentUser || JSON.parse(localStorage.getItem('saii_currentUser') || 'null');
    ...
    applyLanguage() {
        ...
        const transMap = isEn ? {
            // View titles and card headers
            'Configuración': 'Configuration',
            'Datos del Instituto': 'Institute Details',
            'Preferencias del Sistema': 'System Preferences',
            'Configuración Académica': 'Academic Settings',
            'Nuevo Alumno': 'New Student',
            'Nuevo Docente': 'New Teacher',
            'Nuevo Curso': 'New Course',
            'Abrir Nuevo Grupo Académico': 'Open New Academic Group',
            'Editar Usuario': 'Edit User',
            'Editar Permisos de Rol': 'Edit Role Permissions',
            'Nuevo Reporte Personalizado': 'New Custom Report',
            
            // Labels inside settings module
            ...
            'Idioma': 'Language',
            'Período Académico Actual': 'Current Academic Period',
            'Nota Mínima Aprobatoria': 'Minimum Passing Grade',
            'Asistencia Mínima Requerida (%)': 'Minimum Attendance Required (%)',
            'Responsable Académico / Firma': 'Academic Authority / Signature',
            ...
            '-- Seleccione un docente --': '-- Select a teacher --',
            'Abierto': 'Open',
            'En curso': 'In progress',
            'Terminado': 'Finished',
            'Cerrado': 'Closed',
            'Promoción 2026': 'Promotion 2026',
            'Promoción 2025': 'Promotion 2025',
            'Promoción 2024': 'Promotion 2024',
            'Promoción 2023': 'Promotion 2023',
            'Promoción 2022': 'Promotion 2022',
            'Promoción 2021': 'Promotion 2021',
            'Promoción 2020': 'Promotion 2020',
            'Promoción 2019': 'Promotion 2019',
            'Promoción 2018': 'Promotion 2018',
            'Promoción 2017': 'Promotion 2017',
            ...
            'Institute Details': 'Datos del Instituto',
            ...
            'Open New Academic Group': 'Abrir Nuevo Grupo Académico',
            ...
            'Language': 'Idioma',
            'Current Academic Period': 'Periodo Académico Actual',
            'Minimum Passing Grade': 'Nota Mínima Aprobatoria',
            'Minimum Attendance Required (%)': 'Asistencia Mínima Requerida (%)',
            'Academic Authority / Signature': 'Responsable Académico / Firma',
            'Save Changes': 'Guardar Cambios',
            'Restore defaults': 'Restaurar valores por defecto',

            // Labels inside modals
            'Student Code *': 'Código de Alumno *',
            'DNI *': 'DNI *',
            'First Names *': 'Nombres *',
            ...
            '-- Select a teacher --': '-- Seleccione un docente --',
            'Open': 'Abierto',
            'In progress': 'En curso',
            'Finished': 'Terminado',
            'Closed': 'Cerrado',
            'Promotion 2026': 'Promoción 2026',
            'Promotion 2025': 'Promoción 2025',
            'Promotion 2024': 'Promoción 2024',
            'Promotion 2023': 'Promoción 2023',
            'Promotion 2022': 'Promoción 2022',
            'Promotion 2021': 'Promoción 2021',
            'Promotion 2020': 'Promoción 2020',
            'Promotion 2019': 'Promoción 2019',
            'Promotion 2018': 'Promoción 2018',
            'Promotion 2017': 'Promoción 2017',
    ...
    async handleForgotPasswordSubmit(e) {
        ...
        try {
            ...
            this.showToast('Código enviado a tu correo. Revisa tu bandeja de entrada o spam.', 'success');
        } catch (error) {
    ...
    replaceUnicodeIcons(container = document) {
        ...
        const svgMap = {
            ...
            '✏️': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>`,
            '✏': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>`,
            ...
            '🗑️': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>`,
            '🗑': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>`,
            '🔑': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.778-7.778zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path></svg>`,
            ...
            '🔓': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 9.9-1"></path></svg>`,
            ...
            '+': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>`,
            '+✓': `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="15 9 18 12 22 8"></polyline></svg>`
        };
